...
<form action="insertAuditor.php" method="post" enctype="multipart/form-data">
User ID:       <input type="text" name="user_id" value="<?php echo"$uniqueId"; ?>" required><br>
Password: <input type="text" name="user_password" required><br>
Name:            <input type="text" name="name" required><br>
		     
Address:            <input type="text" name="add1" required><br>
