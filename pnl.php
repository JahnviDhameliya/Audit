...
<div id="page-wrapper">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <form method='POST' name='pnl' action='pnl.php'>
...
?>
                ...
                <?php
                   ...
                   $sql4="INSERT INTO pnl (customer_id,year) values ('$customer_id','$year')";
                ...
                <tr>
                  ...
                  echo "<td>"."<a href='print_pnl.php?&customer_id=".$customer_id. " &year=".$year."''>Print</a></td>\n";
                    ...
                    echo "
                    <h1>PROFIT AND LOSS A/C FOR YEAR</h1> <br>
               ...
               if ($result8->num_rows > 0) {
                ...
                echo "<tr>\n";
                    ...
                    echo "<td>"."<a href='edit_pnl.php?&client_id=".$row8["customer_id"]. " &year=".$row8['year']."''>Edit</a></td>\n";
                    echo "<td>"."<a href='print_pnl.php?&customer_id=".$row8["customer_id"]. " &year=".$row8['year']."''>Print</a></td>\n";
